...
namespace Nop.Web.Models.ChuyenPhatNhanh
{
    ...
    public class PhieuChuyenPhatModel : BaseNopEntityModel
    {
        public PhieuChuyenPhatModel()
        {
            ...
            banggiacuochanghoas = new List<BangGiaCuocHangHoaModel>();
        }
        public List<BangGiaCuocHangHoaModel> banggiacuochanghoas { get; set; }
        ...
        public class BangCuocGiaHangHoaModel
        {
