...
namespace Nop.Services.ChuyenPhatNhanh
{
    public class PhieuChuyenPhatService  : IPhieuChuyenPhatService 
    {
        ...
        private readonly IRepository<BangGiaCuoc> _banggiancuocRepository;
         public PhieuChuyenPhatService(
            ...
            IRepository<PhieuChuyenPhat> phieuchuyenphatRepository,
             ...
             IRepository<BangGiaCuoc> banggiancuocRepository
            )
        {
            ...
            this._banggiancuocRepository = banggiancuocRepository;
        }
        #endregion
        ...
        #region van phong vuot tuyen
         ...
         #endregion
         #region bang gia cuoc hang hoa
         public List<BangGiaCuoc> GetAllBangGiaCuocHangHoa(int NhaXeId)
         {
             return _banggiancuocRepository.Table.Where(c => c.NhaXeId == NhaXeId).ToList();
         }
         public BangGiaCuoc GetBangCuocGiaHangHoaById(int Id)
         {
             return _banggiancuocRepository.GetById(Id);
         }
         public void InsertBangGiaCuocHangHoa(BangGiaCuoc item)
         {
             _banggiancuocRepository.Insert(item);
         }
         public void UpadteBangGiaCuocHangHoa(BangGiaCuoc item)
         {
             _banggiancuocRepository.Update(item);
         }
         public void DeleteBangGiaCuocHangHoa(BangGiaCuoc item)
         {
             _banggiancuocRepository.Delete(item);
         }
         #endregion
    }
}
