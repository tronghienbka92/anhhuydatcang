...
namespace Nop.Services.ChuyenPhatNhanh
{
    public partial interface IPhieuChuyenPhatService
    {
        ...
        List<BangGiaCuoc> GetAllBangGiaCuocHangHoa(int NhaXeId);
        BangGiaCuoc GetBangCuocGiaHangHoaById(int Id);
        void InsertBangGiaCuocHangHoa(BangGiaCuoc item);
        void UpadteBangGiaCuocHangHoa(BangGiaCuoc item);
        void DeleteBangGiaCuocHangHoa(BangGiaCuoc item);
        #endregion
    }
}
